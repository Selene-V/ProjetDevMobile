...
public class AjoutFavoriDAO {

    public static void insert(Fragment fragment, Favoris f){

        RequestQueue queue = Volley.newRequestQueue(fragment.getContext());
        String url = "https://devweb.iutmetz.univ-lorraine.fr/~viola11u/WS_PM/php/favoris/insertNewFavori.php?id_client=" + f.getIdClient() + "&id_produit=" + f.getIdProduit();
