...
public class PanierAdapter extends ArrayAdapter<Triplet<Produit, String, Integer>> {
    ...
    private ArrayList<Triplet<Produit, String, Integer>> panierContent;
    private ArrayList<Bitmap> listeImagesProduits;
    private float prixTotal;

    public PanierAdapter(Context context, ArrayList<Triplet<Produit, String, Integer>> panierContent, ArrayList<Bitmap> listeImages) {
